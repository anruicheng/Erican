...
// +kubebuilder:rbac:groups=kb.crd.erican.io,resources=goddessmoments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kb.crd.erican.io,resources=goddessmoments/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kb.crd.erican.io,resources=goddessmoments/finalizers,verbs=update
